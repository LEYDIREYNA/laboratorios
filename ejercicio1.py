...
def idiomas_mas_hablados(num_idiomas):
    ...
    idiomas_mas_top = contador_idiomas.most_common(num_idiomas)
    return idiomas_mas_top
top_idiomas = idiomas_mas_hablados(10)
print('los 10 idiomas mas hablados del mundo son: ')
for idioma, count in top_idiomas:
    print(f'{idioma} : {count} paises')
...
paises_mas_pobladosm = paises_mas_poblados(10)
print('los 10 paises mas poblados del mundo son : ')
for index, country in enumerate(paises_mas_pobladosm, start=1):
